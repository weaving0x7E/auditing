...
contract ChristmasDinner {
    ...
    // @audit deposit 0 也能成为participant??
    ...
    function changeParticipationStatus() external {
        if(participant[msg.sender]) {
            ...
            // @audit Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#block-timestamp
    ...
    function setDeadline(uint256 _days) external onlyHost {
        // @audit The deadline will always be false
        if(deadlineSet) {
